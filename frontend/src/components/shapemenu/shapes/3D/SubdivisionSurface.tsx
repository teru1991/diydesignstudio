...
const SubdivisionSurfaceComponent: React.FC = () => {
    ...
    // Additional state for SubdivisionSurface parameters
    ...
    // 2. Add the validation function for SubdivisionSurface parameters
    const validateSubdivisionSurfaceParams = (params: { param1: string; param2: string }) => {
