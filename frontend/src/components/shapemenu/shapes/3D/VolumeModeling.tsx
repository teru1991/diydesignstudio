...
const VolumeModelingComponent: React.FC = () => {
    ...
    // Additional state for VolumeModeling parameters
    ...
    // 2. Add the validation function for VolumeModeling parameters
    const validateVolumeModelingParams = (params: { param1: string; param2: string }) => {
