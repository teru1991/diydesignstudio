...
const TriangleComponent: React.FC = () => {
    ...
    // Additional state for Triangle parameters
    ...
    // 2. Add the validation function for Triangle parameters
    const validateTriangleParams = (params: { param1: string; param2: string }) => {
