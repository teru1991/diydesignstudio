...
const TrapezoidComponent: React.FC = () => {
    ...
    // Additional state for Trapezoid parameters
    ...
    // 2. Add the validation function for Trapezoid parameters
    const validateTrapezoidParams = (params: { param1: string; param2: string }) => {
