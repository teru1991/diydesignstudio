...
const
    ...
    // Additional state for OffsetCurve parameters
    ...
    // 2. Add the validation function for OffsetCurve parameters
    const validateOffsetCurveParams = (params: { param1: string; param2: string }) => {
