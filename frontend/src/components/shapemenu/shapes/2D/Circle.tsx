...
const CircleComponent: React.FC = () => {
    ...
    // Additional state for Circle parameters
    ...
    // 2. Add the validation function for Circle parameters
    const validateCircleParams = (params: { param1: string; param2: string }) => {
