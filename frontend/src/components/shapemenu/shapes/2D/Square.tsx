...
const SquareComponent: React.FC = () => {
    ...
    // Additional state for Square parameters
    ...
    // 2. Add the validation function for Square parameters
    const validateSquareParams = (params: { param1: string; param2: string }) => {
