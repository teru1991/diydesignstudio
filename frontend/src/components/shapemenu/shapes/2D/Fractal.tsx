...
const FractalComponent: React.FC = () => {
    ...
    // Additional state for Fractal parameters
    ...
    // 2. Add the validation function for Fractal parameters
    const validateFractalParams = (params: { param1: string; param2: string }) => {
