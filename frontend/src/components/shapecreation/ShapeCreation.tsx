import PolyhedronCreation from './3Dshapes/PolyhedronCreation';
import SphereCreation from './3Dshapes/SphereCreation';
import CylinderCreation from './3Dshapes/CylinderCreation';
import SolidModelCreation from './3Dshapes/SolidModelCreation';
import CubeCreation from './3Dshapes/CubeCreation';
import SurfaceCreation from './3Dshapes/SurfaceCreation';
import SplineSurfaceCreation from './3Dshapes/SplineSurfaceCreation';
import SpiralSurfaceShapeCreation from './3Dshapes/SpiralSurfaceShapeCreation';
import FreeformSurfaceCreation from './3Dshapes/FreeformSurfaceCreation';
import BezierSurfaceCreation from './3Dshapes/BezierSurfaceCreation';
import PolygonMeshCreation from './3Dshapes/PolygonMeshCreation';
import ConeCreation from './3Dshapes/ConeCreation';
import NURBSSurfaceCreation from './3Dshapes/NURBSSurfaceCreation';
import MeshCreation from './3Dshapes/MeshCreation';
import HelixSurfaceCreation from './3Dshapes/HelixSurfaceCreation';
import HelixCreation from './3Dshapes/HelixCreation';
import TextureMappedShapeCreation from './3Dshapes/TextureMappedShapeCreation';
import TorusCreation from './3Dshapes/TorusCreation';
import TorusInput from './3Dinputfoms/TorusInput';
import FreeformSurfaceInput from './3Dinputfoms/FreeformSurfaceInput';
import MeshInput from './3Dinputfoms/MeshInput';
import CubeInput from './3Dinputfoms/CubeInput';
import SurfaceInput from './3Dinputfoms/SurfaceInput';
import PolygonMeshInput from './3Dinputfoms/PolygonMeshInput';
import CylinderInput from './3Dinputfoms/CylinderInput';
import SphereInput from './3Dinputfoms/SphereInput';
import BezierSurfaceInput from './3Dinputfoms/BezierSurfaceInput';
import ConeInput from './3Dinputfoms/ConeInput';
import NURBSSurfaceInput from './3Dinputfoms/NURBSSurfaceInput';
import TextureMappedShapeInput from './3Dinputfoms/TextureMappedShapeInput';
import SolidModelInput from './3Dinputfoms/SolidModelInput';
import SplineSurfaceInput from './3Dinputfoms/SplineSurfaceInput';
import HelixSurfaceInput from './3Dinputfoms/HelixSurfaceInput';
// import SpiralSurfaceInputForm from './3Dinputfoms/SpiralSurfaceInputForm';
import HelixInput from './3Dinputfoms/HelixInput';
import PolyhedronInput from './3Dinputfoms/PolyhedronInput';

import HyperbolaCreation from './2Dshapes/HyperbolaCreation';
import RectangleCreation from './2Dshapes/RectangleCreation';
import CircleCreation from './2Dshapes/CircleCreation';
import RegularPolygonCreation from './2Dshapes/RegularPolygonCreation';
import EllipticalArcCreation from './2Dshapes/EllipticalArcCreation';
import BezierCurveCreation from './2Dshapes/BezierCurveCreation';
import ArcCreation from './2Dshapes/ArcCreation';
import DimensionLineCreation from './2Dshapes/DimensionLineCreation';
import IrregularPolygonCreation from './2Dshapes/IrregularPolygonCreation';
import CurveCreation from './2Dshapes/CurveCreation';
import PolylineCreation from './2Dshapes/PolylineCreation';
import EllipseCreation from './2Dshapes/EllipseCreation';
import NURBSSurveCreation from './2Dshapes/NURBSCurveCreation';
import SpiralCreation from './2Dshapes/SpiralCreation';
import TextCreation from './2Dshapes/TextCreation';
import SplineCurveCreation from './2Dshapes/SplineCurveCreation';
import LineCreation from './2Dshapes/LineCreation';
import ParabolaCreation from './2Dshapes/ParabolaCreation';
...
const ShapeCreation: React.FC<ShapeCreationProps> = ({ initialTab }) => {
    ...
    const [wheelerCurveParams, setWheelerCurveParams] = useState({
        controlPoints: ''
    });
    const [cubeCurveParams, setCubeCurveParams] = useState({
        cubeSize: '',
        controlPoints: '' // Add this line
    });
    ...
    const [freehandDrawingParams, setFreehandDrawingParams] = useState(null);
    const shapeTools = selectedShape && (
        <div className="dimension-tools">
            {selectedShape === 'Cube' && <CubeInput />}
            {selectedShape === 'Sphere' && <SphereInput />}
            {selectedShape === 'Cylinder' && <CylinderInput />}
            {selectedShape === 'Polyhedron' && <PolyhedronInput />}
            {selectedShape === 'Cone' && <ConeInput />}
            {selectedShape === 'Torus' && <TorusInput />}
            {/* Add other 3D shapes components as needed */}
        </div>
    );
    ...
    const handleCreateEllipse = (params) => {
        // Your logic here
    };

    const handleCreateLine = (params) => {
        // Your logic here
    };
    const handleCreateCylinder = (params) => {
        // Your logic here
    };
...
return (
        <div className="toolbox">
            ...
            <div className="input-form">
                ...
                {selectedShape && (
                    <div className="dimension-tools">
                        {selectedShape === 'Cube' && <CubeInput onCreate={handleCreateCube} />}
                        {selectedShape === 'Sphere' && <SphereInput onCreate={handleCreateSphere} />}
                        {selectedShape === 'Cylinder' && <CylinderInput onCreate={handleCreateCylinder} />}
                        {/* Add other 3D shapes components as needed */}
                    </div>
                )}
                )
        ...
        {currentTab === '2D' && (
            <div className="drawing-tools">
                {selectedShape === 'Circle' && <CircleCreation onCreate={handleCreateCircle} />}
                {selectedShape === 'Rectangle' && <RectangleCreation onCreate={handleCreateRectangle} />}
                {selectedShape === 'Ellipse' && <EllipseCreation onCreate={handleCreateEllipse} />}
                {selectedShape === 'Line' && <LineCreation onCreate={handleCreateLine} />}
                {/* Add other 2D shapes components as needed */}
            </div>
            <div>
