...
interface SpiralSurfaceShapeCreationProps {
    onCreate: (controlPoints: [number, number, number][]) => void;
}

const SpiralSurfaceShapeCreation: React.FC<SpiralSurfaceShapeCreationProps> = ({ onCreate }) => {
...
export default SpiralSurfaceShapeCreation;
